...
class SeasonalAnimeBloc extends Bloc<SeasonalAnimeEvent, SeasonalAnimeState> {
  ...
  void _onFetchData(
    ...
    Future.forEach(seasonalAnimeList, (item) => _databaseOperations.updateSeasonalAnime(item));
  ...
  void _onLoadData(
    ...
    emit(const SeasonalAnimeState.fetching());
    List<SeasonalAnimeItem> seasonalAnimeList = await _databaseOperations.getSeasonalAnimeList(
      order: event.order,
