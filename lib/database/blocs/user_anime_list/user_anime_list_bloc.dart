...
class UserAnimeListBloc extends Bloc<UserAnimeListEvent, UserAnimeListState> {
  ...
  void _onFetchData(
    ...
    http.Response response = await http.get(
      Uri.parse('https://api.myanimelist.net/v2/users/@me/animelist?fields=list_status&limit=999'),
  ...
  void _onLoadData(
    ...
    emit(const UserAnimeListState.fetching());
    List<UserAnimeListItem> userAnimeList = await _databaseOperations.getUserAnimeList(
      status: event.status,
      order: event.order,
