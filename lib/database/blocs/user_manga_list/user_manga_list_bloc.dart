...
class UserMangaListBloc extends Bloc<UserMangaListEvent, UserMangaListState> {
  ...
  void _onFetchData(
    ...
    http.Response response = await http.get(
      Uri.parse('https://api.myanimelist.net/v2/users/@me/mangalist?fields=list_status&limit=999'),
  ...
  void _onLoadData(
    ...
    emit(const UserMangaListState.fetching());
    List<UserMangaListItem> userMangaList = await _databaseOperations.getUserMangaList(
      status: event.status,
      order: event.order,
