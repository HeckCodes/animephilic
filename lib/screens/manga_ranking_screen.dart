  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.atEdge) {
        ...
        if (!isTop) {
          MangaRankingBloc.instance.add(
            MangaRankingEventFetchNextData(
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('More data loaded.', style: TextStyle(color: Theme.of(context).colorScheme.onSurface)),
                ...
                builder: (context, state) {
                  if (state.mangaRankingList == null || state.state == MangaRankingDataState.fetching) {
                    ...
                    if (state.mangaRankingList!.isEmpty) {
                      return const Center(child: Text("Fetch data using 'sync' button"));
                    }
                    return Visibility(
                      visible: isGridView,
